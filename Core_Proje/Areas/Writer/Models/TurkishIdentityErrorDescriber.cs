...
namespace Core5BlogApp.Areas.Writer.Models
{
    public class TurkishIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        public override IdentityError PasswordTooShort(int length) { return new IdentityError { Code = nameof(PasswordTooShort), Description = $"Parola en az {length} karakter uzunluğunda olmalı." }; }
